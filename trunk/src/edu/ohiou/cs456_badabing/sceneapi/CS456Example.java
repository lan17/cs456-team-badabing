 ...
 implements GLEventListener, KeyListener
{
    ...
    public void display(GLAutoDrawable gLDrawable)
    {
        ...
        gl.glTranslatef(0.0f, 0.0f, -10.0f); // camera looks into -z direction, so lets move the cube in front of the camera, otherwise it would be too close to it.
    ...
    public void init(GLAutoDrawable gLDrawable)
    {
        ...
        chart.clear();
        chart.put( "lol", new Double( .2 ) );
        chart.put( "lol2", new Double( .2 ) );
        chart.put( "lol3", new Double( .4 ) );
        chart.put( "lol4", new Double( .1 ) );
        chart.put(  "lol5", new Double( .1 ) );

        PieChart chart2 = new PieChart();
        chart2.translation().setX( -2 );
        chart.addChild( chart2 );
        //chart.translation().setZ( -10 );
