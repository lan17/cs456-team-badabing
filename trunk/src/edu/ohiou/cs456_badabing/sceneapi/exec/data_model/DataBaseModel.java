...
public class DataBaseModel
{
    ...
    private double max_population = Double.MAX_VALUE * -1.0;
    private double min_population = Double.MAX_VALUE;
    ...
    public void addTuple( DeerTuple new_tuple )
    {
        ...
        if( max_population < sum ) max_population = sum;
        if( min_population > sum ) min_population = sum;
