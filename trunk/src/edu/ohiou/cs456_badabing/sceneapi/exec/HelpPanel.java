...
public class HelpPanel extends JEditorPane
{
    ...
    public HelpPanel()
    {
                ...
                setText("<html><head><font size=6 face=Georgia>Accounting Style Deer Population Model Visualizer</head>"+
                                        "<body><br>CS 456 Spring 2008 <br><u>Team BadaBing</u><font size=3 /><i/><br>Lev Neiman<br>Ryan Whiteside<br>Gene Farber<br>"+
                                        "Jared Hollins<br></i></font><br><font size=3 ><u>Shortcut Keys</u></font><br>"+
                                        "<font size=3>Ctrl-O   Open Excel File<br>Ctrl-S   Save Screenshot<br>Ctrl-X   Exit Program<br><br>Ctrl-1   View District Map Texture"+
                                        "<br>Ctrl-2   View Deer Management Map Texture<br>Ctrl-3   View Plain Black/White Map Texture</font>"+
                                        "<br></font><br><font size=3 ><u>Quick Facts</u></font><br><br><font size=4>-To load new harvest data and visualize it go to File->Open and select an "+
