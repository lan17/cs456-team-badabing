...
public class MainUIPanel extends JPanel implements ActionListener
{
    ...
    public static final String show_hide_charts_text = "Show/Hide pie charts";
    ...
    public void actionPerformed( ActionEvent e )
    {
        ...
        if( command.equals( open_file_text ) )
        {
            if( file_chooser.showOpenDialog( this ) == file_chooser.APPROVE_OPTION )
            {
                ...
                try
                {
                    db = DataBaseModel.readFile(file_chooser.getSelectedFile().
                                                getAbsolutePath());
        ...
        if( command.equals( this.use_deer_managment_map ) )
        {
            rendera.map.useDeerManagmentMap( rendera );
        }
        if( command.equals( this.use_district_map ) )
        {
            rendera.map.useDistrictMap( rendera );
        }
        if( command.equals( this.use_plain_map ) )
        {
