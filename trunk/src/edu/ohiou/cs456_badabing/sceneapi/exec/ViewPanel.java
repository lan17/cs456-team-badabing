...
public class ViewPanel extends GLJPanel implements GLEventListener, MouseListener, MouseMotionListener, Runnable, KeyListener
{
    ...
    private class zoomerInner
    {
        ...
        public void step()
        {
            ...
            scale = interpolate(scale_i, 2, start_time, start_time + duration, System.currentTimeMillis());
        ...
        {
            return ( start_time + duration ) < System.currentTimeMillis();
        }
    ...
    public synchronized void update()
    {
        ...
        for( DeerTuple deer : main_panel.db.tuples )
        {
            if( deer.year == main_panel.current_year )
            {
                ...
                double max_population = main_panel.db.getMaxPopulation();
                double min_population = main_panel.db.getMinPopulation();
