...
public class ViewPastPanel extends JPanel implements MainUIPanelChild
{
    ...
    JButton visual = new JButton("Visualize");
    ...
    private void jbInit()throws Exception
    {
        ...
        hGroup.addGroup(layout.createParallelGroup().addComponent(jLabel1).addComponent(jLabel2)
                        ...
                        .addComponent(yearling).addComponent(fawn).addComponent(visual));
        ...
        vGroup.addGroup(layout.createParallelGroup(Alignment.BASELINE).addComponent(visual));
