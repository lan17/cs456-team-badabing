...
/**
 * <p>MenuBar that is on top of our program. (File, View, Help)</p>
 *
...
public class MenuBar extends JMenuBar implements MainUIPanelChild
{
            ...
            throws Exception
    {
        ...
        help_menu.setMnemonic( KeyEvent.VK_E );

        JMenuItem about = new JMenuItem( main_panel.help_about_text );
        about.setMnemonic( KeyEvent.VK_A );
        about.addActionListener( main_panel );
        help_menu.add( about );
...
/**
 *
 * <p>Used by MenuBar to handle map texture selection.</p>
 *
 * <p>Description: Experimentation with JOGL</p>
 *
 * <p>Copyright: Copyright (c) 2008, Lev A Neiman</p>
