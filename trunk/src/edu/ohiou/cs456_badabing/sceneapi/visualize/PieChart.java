...
public class PieChart extends ANode
{
    ...
    */
    ...
    {
        members = null;
        members = new TreeMap<String, Double >();
    }
     ...
     */
    public java.awt.Color [] colors = { Color.BLUE, Color.RED, Color.GREEN, Color.CYAN, Color.pink };
        ...
        if( show )
        {
            ...
            for (Object n : members.keySet().toArray())
            {
                ...
                for (double i = 0; i < 2f * PI * size; i += detail)
                {
                    ...
                    Coordinate ar = Coordinate.add(a,
                            Coordinate.multiply(depth, 2));
                    Coordinate br = Coordinate.add(b,
                            Coordinate.multiply(depth, 2));
                    Coordinate cr = Coordinate.add(c,
                            Coordinate.multiply(depth, 2));
