...
import java.io.*;
import edu.ohiou.lev_neiman.sceneapi.data.*;
import java.util.zip.*;
import java.util.*;
import edu.ohiou.lev_neiman.sceneapi.*;

/**
 * <p>Title: class ModelFile</p>
 *
 * <p>Description: this class is container for data loaded from OBJ and MTL files.  It prepares it for use in ModelNode.</p>
 *
